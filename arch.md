...
**Workflow**:
1. Получение темы со статусом 'new' из БД
2. Генерация промптов через Gemini
3. Для каждого изображения: выбор случайного соотношения сторон
4. Генерация изображений через Flux/Imagen4 с выбранным соотношением
5. Upscale изображений
6. Встраивание IPTC метаданных
7. Загрузка на Adobe Stock через SFTP (официальный метод с 2021 года)
8. Сохранение статистики загрузки (количество и дата)
9. Обновление статуса на 'done'
